function [MaxACC] = avgKernelPerceptronExp(trainvector,testvector,epoch,d)
tic;
...
for T = epoch # should be done for 1 to 20
	...
	for digit = 0:9
		...
		alpha = [alpha polyavgKernelPerceptron(fname,T,d)]; # appending column vectors of Wd return for each digit
		dt = load(fname);
